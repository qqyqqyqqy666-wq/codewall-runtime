...
final class HostMenuController: NSObject {
  ...
  func installMenu() {
    NSLog("[CodewallHost][Diag] HostMenuController.installMenu")
    ...
    NSLog("[CodewallHost][Diag] menu installed: statusMenuItems=%ld launchItemsTracked=%ld",
          statusMenu.items.count,
          launchAtLoginMenuItems.count)
  }
